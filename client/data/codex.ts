...
export type Arcana = {
  ...
  theme: string;
  abilities: string[];
  rareSub?: { name: string; theme: string; abilities: string[] };
};
...
export const timeline = [
  ...
  {
    era: "Age of Shaping (−∞ to −5000)",
    text: "Aecron, Solyra, Ordrin, and Alastor craft the realms; Elyndor, Pangea, Khazdyr, and the Underworld take form.",
  },
  {
    era: "Dawn of Titans (−5000 to −3000)",
    text: "Giants awaken; Monoliths erected; Astral Spirits bond with chosen titans.",
  },
  {
    era: "First Mortals (−3000 to −1500)",
    text: "Humans, elves, dwarves and others appear across far continents and Pangea; early kingdoms rise.",
  },
  {
    era: "Fitz's Gift (−1500)",
    text: "Fitz teaches mortals diluted Astral techniques; 'Magic' and innate 'Traits' emerge.",
  },
  {
    era: "The War of the Heavens (−1500 to 0)",
    text: "Alastor corrupts mortals and breeds demonic giants; realms scarred by millennia of conflict.",
  },
  {
    era: "0 AA",
    text: "Oving defeats Alastor, banishes him to the Underworld; the Astral Thrones are sealed.",
  },
  {
    era: "1–300 AA",
    text: "The Withering Centuries; collateral storms and rifts; many giants vanish into a hidden realm.",
  },
  {
    era: "301–420 AA",
    text: "Reclamation; mortals stabilize, monolith use spreads.",
  },
  {
    era: "421–600 AA",
    text: "Rebuilding; trade among Pangea, Elyndor, and Khazdyr resumes; Underworld cults go to ground.",
  },
  {
    era: "649 AA (Now)",
    text: "Rifts open; a reincarnated hero awakens. Fitz guides in disguise; Alastor tempts under an assumed godhood.",
  },
];
...
export const world = {
  ...
  realms: [
    {
      name: "Elyndor",
      text: "Aecron/Time; elven halls across slow-time vales.",
    },
    {
      name: "Khazdyr",
      text: "Ordrin/Order; dwarf citadels carved by law-bound geometry.",
    },
    {
      name: "Underworld",
      text: "Alastor's malformed realm; portals bleed corruption into Htrea.",
    },
    {
      name: "Hidden Giant Realm",
      text: "Rumored sanctuary accessible only by Astral rites.",
    },
  ],
  races: [
...
export const traits: Trait[] = [
  ...
  {
    name: "Starforged",
    description: "Slight resistance to astral corruption.",
  },
...
export const arcana: Arcana[] = [
  ...
  {
    name: "Ice",
    theme: "freezing, control, defense",
    abilities: [
      "Frost Shard",
      "Snowbind",
      "Glacial Wall",
  ...
  {
    name: "Earth",
    theme: "stability, stone, brute force",
    abilities: [
      "Pebble Toss",
      "Earthen Armor",
      "Tremor",
    ...
    rareSub: {
      name: "Crystal",
      theme: "radiant refined minerals",
      abilities: [
        "Crystal Shard",
        "Prism Barrier",
        "Diamond Skin",
  ...
  {
    name: "Wind",
    theme: "mobility and battlefield control",
    abilities: [
      "Gust",
      "Feather Step",
      "Wind Slash",
  ...
  {
    name: "Light",
    theme: "healing, protection, illumination",
    abilities: [
      "Radiant Spark",
      "Blessing of Dawn",
      "Blinding Flash",
...
export const legendary = [
  ...
  {
    name: "Matter/Creation — Aetherforge (Solyra)",
    abilities: [
  ...
  {
    name: "Order — Celestial Decree (Ordrin)",
    abilities: [
  ...
  {
    name: "Antimatter/Corruption — Abyssal Rift (Alastor)",
    abilities: [
  ...
  {
    name: "Oving's Light — All-Father's Blessing",
    abilities: [
  ...
  {
    name: "Giant's Might — Astral Titan Arts",
    abilities: [
...
export const races = [
  {
    name: "Humans",
    perk: "Adaptive: gain experience faster; flexible builds.",
  },
  { name: "Elves", perk: "Arcane Grace: larger mana pool and regen." },
  { name: "Dwarves", perk: "Stone Oath: higher defense and mining yield." },
  {
    name: "Giants (Hidden/Legacy)",
    perk: "Titan Blood: immense strength, astral synergy (unlock via endgame quest).",
  },
  {
    name: "Demonic (Alastor's)",
    perk: "Riftborne: immune to minor curses, weak to light (restricted or NPC foe).",
  },
];
